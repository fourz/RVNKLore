...
**Authoritative Location**: `docs/architecture/rvnklore-database-refactor.md`
**Last Updated**: January 30, 2026
**Status**: Planning (partial implementation via RVNKCore integration)

**Related Documentation**:

- Schema Reference: [../standard/rvnklore-schema.md](../standard/rvnklore-schema.md)
- Database API: [../standard/rvnklore-database-api.md](../standard/rvnklore-database-api.md)
- Database Patterns: [../standard/database-patterns.md](../standard/database-patterns.md)
