...
public class ItemProperties {
    ...
    /**
     * Get the pages for a written book item
     *
     * @return List of page strings, or null if not set
     */
    ...
    /**
     * Set the pages for a written book item
     *
     * @param pages List of page strings
     * @return This ItemProperties instance for chaining
     */
    public ItemProperties setPages(List<String> pages) {
        this.pages = pages;
        return this;
    }
}
