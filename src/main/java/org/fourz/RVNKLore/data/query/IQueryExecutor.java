...
/**
 * Executes SQL queries built by IQueryBuilder and maps results to DTOs.
...
public interface IQueryExecutor {
     ...
     */
    <T> CompletableFuture<T> executeQuery(IQueryBuilder builder, Class<T> dtoClass);
     ...
     */
    <T> CompletableFuture<List<T>> executeQueryList(IQueryBuilder builder, Class<T> dtoClass);
     ...
     */
    CompletableFuture<Integer> executeUpdate(IQueryBuilder builder);
     ...
     */
    CompletableFuture<Integer> executeInsert(IQueryBuilder builder);
     ...
     */
    CompletableFuture<int[]> executeBatch(IQueryBuilder builder, List<Object[]> batchParams);
}
